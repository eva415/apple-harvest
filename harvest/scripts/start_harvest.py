...
class StartHarvest(Node):
    def __init__(self):
        ...
        self.declare_parameter('pick_pattern', 'relative_z_motion_controller')
        ...
        if self.PICK_PATTERN == 'relative_z_motion_controller':
            self.relative_motion_client = self.make_client(Trigger, '/relative_z_motion') # made a service client
    ...
    def call_relative_motion(self):
        req = Trigger.Request()
        self.get_logger().info('Calling /relative_z_motion service...')
        ...
        if future.result() is not None:
            ...
            self.get_logger().error('Failed to call /relative_z_motion service.')
            return False
    ...
    def pick_controller(self):
        ...
        elif self.PICK_PATTERN == 'relative_z_motion_controller': # call my service
