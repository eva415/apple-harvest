...
class CoordinateToTrajectoryService(Node):
    def __init__(self):
        ...
        self.voxel_data = np.loadtxt(os.path.join(package_share_directory, 'resource', 'reachable_voxels_20260204_173336.csv'))
        self.trajectories = np.load(os.path.join(package_share_directory, 'resource', 'reachable_paths_20260204_173336.npy'))
        self.ik_data = np.loadtxt(os.path.join(package_share_directory, 'resource', 'voxel_ik_data_20260204_173335.csv'), delimiter=',', skiprows=1)
